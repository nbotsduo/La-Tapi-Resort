...
Public Class frmEditHall
    ...
    Private Sub frmEditHall_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.ReservationBindingSource.Filter = "Reser_Type= 'Hall' AND Cust_ID=" & Id
